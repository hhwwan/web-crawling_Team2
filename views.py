...
def index(request):
    # 로컬 이미지 파일 경로와 위치 태그를 함께 저장
    images = [
        {"path": "C:/Users/cest0/Desktop/web_crawling_Team2-main/django_project/myproject/ingredients_wordcloud.png", "position": "right"},
        {"path": "C:/Users/cest0/Desktop/web_crawling_Team2-main/django_project/myproject/time_distribution_barplot.png", "position": "left"}
    ]

    base64_images = []
    for img in images:  # 'img'를 참조해야 합니다.
        try:
            with open(img["path"], "rb") as img_file:
                # 각 이미지를 Base64로 인코딩하고 위치 정보 포함
                base64_images.append({
                    "data": f"data:image/png;base64,{base64.b64encode(img_file.read()).decode('utf-8')}",
                    "position": img["position"]
                })
        except FileNotFoundError:
            base64_images.append({"data": None, "position": img["position"]})
